      ...
      {loading ? (
        <div className="space-y-4">
          {[1, 2, 3].map((n) => (
            <div
              key={n}
              className="animate-shimmer h-36 rounded-[var(--radius-lg)] border border-[var(--line)] bg-[var(--panel)] p-6"
            ></div>
          ))}
        </div>
      ) : error ? (
            ...
            >
              <div className="flex flex-wrap items-center justify-between gap-4 border-b border-[var(--line)] pb-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-[var(--gold-deep)]">
                    {money(order.total)}
                  </p>
                </div>
                <div>
              ...
              <div className="mt-4 flex justify-between border-t border-dashed border-[var(--line-strong)] pt-4 text-xs text-[var(--muted)]">
