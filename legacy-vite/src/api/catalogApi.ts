...
export async function fetchProductsApi(
  ...
  const response = await axiosClient.get(API_ROUTES.catalog.products, {
    params,
  });
  return response.data;
}

export async function fetchProductBySlugApi(
  slug: string,
): Promise<ApiResponse<Product>> {
  const response = await axiosClient.get(
    API_ROUTES.catalog.productBySlug(slug),
  );
  return response.data;
}
...
export async function searchProductsApi(
  ...
  const response = await axiosClient.get(API_ROUTES.catalog.search, {
    params: { q: query },
  });
  return response.data;
}

export async function fetchFeaturedProductsApi(): Promise<
  ApiResponse<Product[]>
> {
...
export async function fetchMustHavesProductsApi(): Promise<
  ApiResponse<Product[]>
> {
...
export async function fetchSaleEssentialsProductsApi(): Promise<
  ApiResponse<Product[]>
> {
