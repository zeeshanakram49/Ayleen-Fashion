  ...
  return (
    <footer className="glass-shift border-t border-[var(--line)] bg-[var(--panel)]/90">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 md:grid-cols-[1.2fr_0.8fr_0.8fr_1fr]">
        <div>
          <p className="font-editorial text-3xl font-semibold tracking-[0.22em]">
            AYLEEN
          </p>
          <p className="mt-4 max-w-sm text-sm leading-6 text-[var(--muted)]">
            Premium fashion house for confident silhouettes and modern daily
            style across Pakistan.
          </p>
          <div className="mt-5 space-y-2 text-sm text-[var(--muted)]">
            <p>support@ayleen.pk</p>
            <p>+92 303 4965359</p>
            <p>Ali Town Lahore, Lahore</p>
          </div>
        </div>

        <div>
          <h4 className="text-xs font-semibold tracking-[0.22em] text-[var(--ink)]/75">
            SHOP
          </h4>
