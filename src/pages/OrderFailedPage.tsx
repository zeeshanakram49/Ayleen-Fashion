      ...
      <article className="page-slide-up text-center">
        ...
        {orderId && (
          <p className="mt-2 text-sm font-mono text-[var(--muted)]">
            Reference Order ID: <span className="font-semibold text-[var(--ink)]">{orderId}</span>
          </p>
        )}

        <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-[var(--muted)] border border-red-100 bg-red-50/55 p-4 rounded-[var(--radius-md)] text-red-800">
          {displayMessage}
        </p>
        ...
        <div className="mt-8 rounded-[var(--radius-lg)] border border-[var(--line)] bg-[var(--panel)] p-6 text-left sm:p-7">
          ...
          <p className="mt-2 text-xs leading-relaxed text-[var(--muted)]">
            If funds were deducted from your account or you need custom bank transfer coordination, please contact support:
          </p>
          <div className="mt-4 grid gap-3 text-xs text-[var(--muted)] sm:grid-cols-2">
            <div>
              <span className="block font-semibold text-[var(--ink)]">WhatsApp Helpline:</span>
              <a href="tel:+924235467243" className="hover:text-[var(--gold-deep)] transition">+92 42 35467243</a>
            </div>
            <div>
              <span className="block font-semibold text-[var(--ink)]">Email Support:</span>
              <a href="mailto:support@aylee.pk" className="hover:text-[var(--gold-deep)] transition">support@aylee.pk</a>
            </div>
          </div>
        </div>
