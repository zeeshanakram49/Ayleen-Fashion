      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <article className="reveal-up soft-panel rounded-[2rem] border border-[var(--line)] p-7">
          ...
          <div className="mt-7 space-y-3 text-sm">
            ...
            <p><span className="font-semibold">Hours:</span> Monday to Saturday, 11 AM to 8 PM</p>
          </div>
        </article>

        <form onSubmit={handleSubmit} className="reveal-up delay-1 soft-panel rounded-[2rem] border border-[var(--line)] p-7">
          <h2 className="font-editorial text-3xl">Contact Form</h2>
          <div className="mt-5 grid gap-4">
            <input required placeholder="Name" className="h-11 rounded-xl border border-[var(--line-strong)] bg-white px-4 text-sm outline-none" />
            <input required type="email" placeholder="Email" className="h-11 rounded-xl border border-[var(--line-strong)] bg-white px-4 text-sm outline-none" />
            <input placeholder="Phone" className="h-11 rounded-xl border border-[var(--line-strong)] bg-white px-4 text-sm outline-none" />
            <textarea required placeholder="Message" className="min-h-28 rounded-xl border border-[var(--line-strong)] bg-white px-4 py-3 text-sm outline-none" />
            <button type="submit" className="rounded-full bg-[var(--ink)] px-7 py-3 text-xs tracking-[0.2em] text-[var(--champagne)]">
              SEND MESSAGE
            </button>
            {submitted && (
